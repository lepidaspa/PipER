...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProxyRequest.owner'
        db.alter_column('broker_proxyrequest', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['broker.Owner']))

    def backwards(self, orm):

        # Changing field 'ProxyRequest.owner'
        db.alter_column('broker_proxyrequest', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['broker.Owner']))
