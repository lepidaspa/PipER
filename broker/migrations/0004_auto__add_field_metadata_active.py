...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Metadata.active'
        db.add_column('broker_metadata', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Metadata.active'
        db.delete_column('broker_metadata', 'active')
    ...
    models = {
        ...
        'broker.proxyrequest': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'proxies'", 'to': "orm['broker.Owner']"}),
