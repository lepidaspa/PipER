...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OwnerData'
        db.create_table('broker_ownerdata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['broker.Owner'], unique=True)),
            ('referral_name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('referral_email', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('broker', ['OwnerData'])


    def backwards(self, orm):
        # Deleting model 'OwnerData'
        db.delete_table('broker_ownerdata')
    ...
    models = {
        ...
        'broker.metadatarefreshtime': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metadata': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'timing'", 'to': "orm['broker.Proxy']"})
        },
        'broker.owner': {
