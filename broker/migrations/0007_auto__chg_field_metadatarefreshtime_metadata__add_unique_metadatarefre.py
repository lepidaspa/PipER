...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('broker_metadatarefreshtime', 'metadata_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['broker.Proxy']))
        # Adding unique constraint on 'MetadataRefreshTime', fields ['metadata']
        db.create_unique('broker_metadatarefreshtime', ['metadata_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MetadataRefreshTime', fields ['metadata']
        db.delete_unique('broker_metadatarefreshtime', ['metadata_id'])
